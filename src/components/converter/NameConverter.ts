// NameConverter.ts
export const convertToChineseName = (setName: string, position: string): string => {
    const nameMappings: Record<string, string[]> = {
        ...
        "WatchmakerMasterofDreamMachinations" : ["钟表匠的极目透镜","钟表匠的交运腕表","钟表匠的空幻礼服","钟表匠的隐梦革履"],
        "TheAshblazingGrandDuke":["大公的冥焰冠冕","大公的绒火指套","大公的蒙恩长袍","大公的绅雅礼靴"],
        "PioneerDiverofDeadWaters": ["先驱的绝热围壳","先驱的虚极罗盘","先驱的密合铅衣", "先驱的泊星桩锚"],
        "PenaconyLandoftheDreams": [ "匹诺康尼的堂皇酒店" , "匹诺康尼的逐梦轨道"],
        "FirmamentFrontlineGlamoth" : ["格拉默的铁骑兵团" , "格拉默的寂静坟碑"],
        "PrisonerinDeepConfinement" : ["系囚的合啮拘笼" , "系囚的铅石梏铐" , "系囚的幽闭缚束" , "系囚的绝足锁桎"]
